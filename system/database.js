module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('owners' in setting)) setting.owners = ['6283838057050']
      if (!isNumber(setting.lastReset)) setting.lastReset = new Date * 1
      if (!('msg' in setting)) setting.msg = 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys @adiwajshing/baileys v 6.0.8\n◦ *Rest API* : https://hagozox.repl.co/\n◦ *Room* : https://s.id/hagozox-room\n\nIf you find an error or want to upgrade premium plan contact the owner.'
      if (!isNumber(setting.menuStyle)) setting.menuStyle = 4
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/b17daf1fcecb3c6575878.jpg'
      ...
      global.db.setting = {
         ...
         online: true,
         onlyprefix: '+',
         owners: ['6283838057050'],
         lastReset: new Date * 1,
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys @adiwajshing/baileys v 6.0.8\n◦ *Rest API* : https://hagozox.repl.co/\n◦ *Room* : https://s.id/hagozox-room\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         menuStyle: 4,
         cover: 'https://telegra.ph/file/b17daf1fcecb3c6575878.jpg',
